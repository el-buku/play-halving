...
import CustomHead from "@/components/homepage-header";
export const Homepage:React.FC = () => {
    ...
    const updateDivPosition = (value: number) => {
        if (sliderRef.current && tooltipRef.current) {
            ...
            const position = ((value - 1) / (100 - 1)) * (slider.offsetWidth - tooltip.offsetWidth);
    ...
    return (
        <>
            ...
            <div className="guess-container">
                    ...
                    <div className="container">
                        <div className="slidecontainer">
                            <input
                                ...
                                ref={sliderRef}
                            />
                            <div className="tool" ref={tooltipRef} id="tooltip" style={{display:"none"}}>
                ...
                <div className="guess">
                    <div className="container">
                        ...
                        <div className="flex-btc">
                            <div className="btc-1"><img src='../img/BTC1.png' alt="" /></div>
                            <div className="btc-2"><img src="../img/BTC2.png" alt="" /></div>
                            <div className="btc-4"><img src="../img/BTC4.png" alt="" /></div>
                            <div className="btc-5"><img src="../img/BTC5.png" alt="" /></div>
                            <div className="stone-2"><img src="../img/stone2.png" alt="" /></div>
                            <div className="stone-3"><img src="../img/stone3.png" alt="" /></div>
                            <div className="hammer"><img src="../img/hammer.png" alt="" /></div>
                            <img
                                className="btc-img"
                                src="../img/big.png"
                        ...
                        <div className="count-down-card">
                            ...
                            <div className="count-down-last-section">
                                <button className="green-ticket">Get 1 Ticket For 5.00 USDT</button>
                    ...
                    <div className="container">
                        <div className="game-rules">
                            ...
                            <div className="flex-game">
                                ...
                                <div className="note">
                                    Please note: Each entry is represented by a unique NFT, which
                                    you can claim
                                </div>
                            </div>
                        </div>
                ...
                winner based on who made the earliest correct prediction.</span
                                >
                            </div>
                ...
                you’ll be rewarded with a refund of 50% of the ticket’s value in
                USDT.</span
                                >
                            </div>
                ...
                <div className="live">
                    <div className="container">
                        <div className="live-frame">
                            ...
                            <img style={{maxWidth:317 +"px"}} src="../img/diamonds-btc.png" alt="" />
                        </div>
                ...
                <div className="container">
                    <div className="footer-purple">
                        <div className="text-footer">
                            DISCLIMER:<br />As the Bitcoin having will not return the
                            millisecond of the halving this will be randomly extracted
                        </div>
                        <img
